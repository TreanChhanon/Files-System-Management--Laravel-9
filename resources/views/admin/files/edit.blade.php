...
@section('content')
        ...
        <div class="panel-body">
            <div class="row">
                {{-- <div class="col-xs-12 form-group">
                    {!! Form::label('folder_name', trans('quickadmin.files.fields.folder').'*', ['class' => 'control-label']) !!}
                    {!! Form::select('folder_name', $file, old('folder_name'), ['class' => 'form-control select2', 'required' => '']) !!}
    ...
    <a href="{{ route('admin.files.index') }}" class="btn btn-danger">@lang('quickadmin.qa_back_to_list')</a>
    {!! Form::close() !!}
@stop
