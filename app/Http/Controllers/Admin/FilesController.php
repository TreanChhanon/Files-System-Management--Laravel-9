...
class FilesController extends Controller
{
    ...
    public function store(StoreFilesRequest $request)
    {
        if (!Gate::allows('file_create')) {
            ...
            return redirect()->route('admin.files.index')->with('success', 'Files has been Created');
    ...
    public function edit($id)
    {
        ...
        // //return view('admin.files.edit');//, compact('file', 'created_bies'));
        // //return view('admin.files.edit',compact('file', $file));
        // //return view ('admin.files.edit',compact('file',$file));
        // $file = File::find($id);
        // return view('admin.files.edit', compact('file', $file));
        if (! Gate::allows('file_edit')) {
    ...
    public function update(UpdateFilesRequest $request, $id)
    {
        ...
        return redirect()->route('admin.files.index')->with('success', 'Files has been Updated');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.files.index')->with('success', 'Files has been deleted');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('admin.files.index')->with('success', 'Files has been Restore');
    }
    ...
    public function perma_del($id)
    {
        ...
        return redirect()->route('admin.files.index')->with('success', 'Files has been deleted from Trash');
    }
}
