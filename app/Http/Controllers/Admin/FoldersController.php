...
class FoldersController extends Controller
{
    ...
    public function store(StoreFoldersRequest $request)
    {
        ...
        return redirect()->route('admin.folders.index')->with('success', 'Folder has been Created');
    }
    ...
    public function update(UpdateFoldersRequest $request, $id)
    {
        ...
        return redirect()->route('admin.folders.index')->with('success', 'Folder has been Updated');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.folders.index')->with('success', 'Folder has been Deleted');
    }
